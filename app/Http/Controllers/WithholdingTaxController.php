...
class WithholdingTaxController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'representative_tax_id' => 'nullable|string|max:13',
            'representative_name' => 'nullable|string|max:255',
            'representative_address' => 'nullable|string',
            'deduction_mode' => 'nullable|string|max:50',
            'deduction_other' => 'nullable|string|max:255',
            'deduction_format' => 'nullable|string|max:50',
            'deduction_order' => 'nullable|string|max:50',
        ...
        try {
            ...
            $tax = WithholdingTax::create([
                ...
                'deduction_mode' => $validated['deduction_mode'] ?? null,
                'deduction_other' => $validated['deduction_other'] ?? null,
                'deduction_format' => $validated['deduction_format'] ?? null,
                ...
                'representative_tax_id' => $validated['representative_tax_id'] ?? null,
